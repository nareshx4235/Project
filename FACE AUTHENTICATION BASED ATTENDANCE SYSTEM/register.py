...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Ybhat\OneDrive\Desktop\Final year project\college_images\bgReg.jpg")
        
        lb1_bg=Label(self.root,image=self.bg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame= Frame(self.root,bg="#F2F2F2")
        frame.place(x=220,y=55,width=900,height=600)
        

        # img1=Image.open(r"D:\face_recognition system\college_images\reg1.png")
        ...
        self.txtuser.place(x=103,y=230,width=270)
        ...
        self.txtpwd.place(x=103,y=300,width=270)
        ...
        self.txtuser.place(x=533,y=230,width=270)
        ...
        self.txtpwd.place(x=533,y=300,width=270)
        ...
        self.combo_security.place(x=103,y=380,width=270)
        ...
        self.txtpwd.place(x=103,y=450,width=270)
        ...
        self.txtuser.place(x=533,y=380,width=270)
        ...
        self.txtpwd.place(x=533,y=450,width=270)

        # Condition
        checkbtn = Checkbutton(frame,variable=self.var_check,text="I Agree the Terms & Conditions",font=("times new roman",15,"italic"),fg="#002B53",bg="#F2F2F2")
        checkbtn.place(x=50,y=500,width=400)
        ...
        loginbtn.place(x=103,y=550,width=270,height=35)
        ...
        loginbtn.place(x=533,y=550,width=270,height=35)
